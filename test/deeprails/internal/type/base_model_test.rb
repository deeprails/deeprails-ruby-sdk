...
class Deeprails::Test::PrimitiveModelTest < Minitest::Test
  A = Deeprails::Internal::Type::ArrayOf[-> { Integer }]
  H = Deeprails::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Deeprails::Internal::Type::Union
  end

  class B < Deeprails::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Deeprails::Internal::Type::Unknown,
      Deeprails::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Deeprails::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Deeprails::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Deeprails::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Deeprails::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Deeprails::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Deeprails::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Deeprails::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Deeprails::Internal::Type::Boolean, true] => true,
      [Deeprails::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Deeprails::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Deeprails::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Deeprails::Internal::Type::Converter.new_coerce_state
      Deeprails::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Deeprails::Internal::Type::Converter.dump(target, input, state: state)
...
class Deeprails::Test::EnumModelTest < Minitest::Test
  class E0
    include Deeprails::Internal::Type::Enum
...
class Deeprails::Test::CollectionModelTest < Minitest::Test
  A1 = Deeprails::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Deeprails::Internal::Type::HashOf[Integer]

  A2 = Deeprails::Internal::Type::ArrayOf[H1]
  H2 = Deeprails::Internal::Type::HashOf[-> { A1 }]

  A3 = Deeprails::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Deeprails::Internal::Type::HashOf[Integer, nil?: true]
...
class Deeprails::Test::BaseModelTest < Minitest::Test
  class M1 < Deeprails::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Deeprails::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Deeprails::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Deeprails::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Deeprails::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Deeprails::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Deeprails::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Deeprails::Errors::ConversionError => e
...
class Deeprails::Test::UnionTest < Minitest::Test
  class U0
    include Deeprails::Internal::Type::Union
  ...
  class M2 < Deeprails::Internal::Type::BaseModel
  ...
  class M4 < Deeprails::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Deeprails::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Deeprails::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Deeprails::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Deeprails::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Deeprails::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Deeprails::Internal::Type::Unknown, Deeprails::Internal::Type::Unknown] => true,
      [Deeprails::Internal::Type::Boolean, Deeprails::Internal::Type::Boolean] => true,
      [Deeprails::Internal::Type::Unknown, Deeprails::Internal::Type::Boolean] => false,
...
class Deeprails::Test::MetaInfoTest < Minitest::Test
  A1 = Deeprails::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Deeprails::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
