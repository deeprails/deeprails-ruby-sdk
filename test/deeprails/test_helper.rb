...
class Deeprails::Test::SingletonClient < Deeprails::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Deeprails::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Deeprails::Test::ResourceTest < Minitest::Test
  def async?
