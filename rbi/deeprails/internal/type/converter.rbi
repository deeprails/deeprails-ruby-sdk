  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Deeprails::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            ...
            ).returns(Deeprails::Internal::AnyHash)
          end
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Deeprails::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Deeprails::Internal::Type::Converter::Input,
              value: T.anything,
              state: Deeprails::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
