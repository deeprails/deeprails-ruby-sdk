...
module Deeprails
  class Client < Deeprails::Internal::Transport::BaseClient
    ...
    # @return [Deeprails::Resources::Defend]
    attr_reader :defend
    ...
    def initialize(
      ...
      base_url ||= "https://api.deeprails.com"

      if api_key.nil?
        raise ArgumentError.new("api_key is required, and can be set via environ: \"DEEPRAILS_API_KEY\"")
      end

      headers = {}
      custom_headers_env = ENV["DEEP_RAILS_CUSTOM_HEADERS"]
