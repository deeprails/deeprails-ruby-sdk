...
module Deeprails
  module Internal
    module Type
      ...
      # `Deeprails::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Deeprails::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Deeprails::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Deeprails::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Deeprails::FilePart.new(value, filename: "upload") : value
            in Deeprails::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, Deeprails::FilePart)
          end
        end
      end
    end
