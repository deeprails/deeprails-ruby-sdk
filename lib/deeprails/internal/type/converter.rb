    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Deeprails::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Deeprails::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Deeprails::FilePart.new(value)
          in Deeprails::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Deeprails::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Deeprails::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Deeprails::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Deeprails::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Deeprails::Internal::Type::Converter
              ...
              Deeprails::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Deeprails::Internal::Type::Converter, T::Class[T.anything]) }
        end
