  ...
  module Errors
    ...
    class APIStatusError < Deeprails::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Deeprails::Errors::BadRequestError.new(**kwargs)
        in 401
          Deeprails::Errors::AuthenticationError.new(**kwargs)
        in 403
          Deeprails::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Deeprails::Errors::NotFoundError.new(**kwargs)
        in 409
          Deeprails::Errors::ConflictError.new(**kwargs)
        in 422
          Deeprails::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Deeprails::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Deeprails::Errors::InternalServerError.new(**kwargs)
        else
          Deeprails::Errors::APIStatusError.new(**kwargs)
        end
      end
