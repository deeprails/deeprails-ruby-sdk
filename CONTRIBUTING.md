...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/deeprails/helpers/` and `examples/` directory.
...
require_relative "../lib/deeprails"
...
```ruby
gem "deeprails", git: "https://www.github.com/stainless-sdks/deeprails-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/deeprails-ruby' '<path-to-repo>'
```

```ruby
gem "deeprails", path: "<path-to-repo>"
```
